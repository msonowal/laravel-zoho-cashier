...
class SubscriptionBuilder
{
    ...
    /**
     * Create a new Zoho subscription.
     *
    ...
    /**
     * Get the Zoho customer instance for the current user and token.
     *
     * @param  string|null  $token
     * @param  array  $options
     * @return \Zoho\Customer
     */
    protected function getZohoCustomer($token = null, array $options = [])
    {
        if (! $this->owner->zoho_id) {
            $customer = $this->owner->createAsZohoCustomer($token, $options);
        } else {
            $customer = $this->owner->asZohoCustomer();
